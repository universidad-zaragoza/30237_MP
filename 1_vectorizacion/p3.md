...
1.  La función `RGB2YCbCr_roundf0()` convierte una imagen en formato RGB a YCbCr (YUV444).
    ...
    Siendo (R,G,B) los componentes RGB de cada píxel de la imagen sobre la que se aplica la conversión.
...
2.  Verifica que la conversión funciona correctamente.
    Para ello, recompila y ejecuta el programa `test_RGB2YCbCr.c`:
