...
2.  Escribe una nueva versión del bucle, `axpby_intr_AVX()`, vectorizando de forma
    ...
    Lista el código correspondiente a la función `axpby_intr_AVX()`.
    ...
    ¿Hay diferencia apreciable en el rendimiento de las funciones `axpby()` (versión vec.avx) y `axpby_intr_AVX()`?
