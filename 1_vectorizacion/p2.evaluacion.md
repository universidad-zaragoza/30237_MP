...
_Los tiempos y métricas deberán obtenerse para máquinas de los laboratorios L0.03 o L1.02.
...
**Plazo límite de entrega: domingo, 15 de marzo, 23h59m.**
...
1.  Para cada instrucción de escritura en memoria ejecutada,
	...
	|:------------------------------------:|:----------:|:----------|
	|    `vmovaps %ymm0,0x4060a0(%rax)`    |     V8A    | `0x404080`|
	|    `vmovaps %ymm0,0x4060a0(%rax)`    |     V8A    |           |
	|    `vmovaps %ymm0,0x4060a0(%rax)`    |     V8A    |           |
	|    `vmovaps %ymm0,0x4060a0(%rax)`    |     V8A    |           |
